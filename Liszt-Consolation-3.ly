% downloaded from https://www.mutopiaproject.org/ftp/LisztF/S.172/liszt-consolation-no3/liszt-consolation-no3.ly
...
% Local Variables:
% compile-command: "make Liszt-Consolation-3-letter.pdf"
% End:
