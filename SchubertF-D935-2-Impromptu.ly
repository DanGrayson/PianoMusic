...
OCTAVEBEG = { \ottava #1 \set Staff.ottavation = #"8" }
OCTAVEEND = \ottava #0
%----- CHANGER DE PORTÉE
...
CRESC   = {
  \set crescendoText = \markup { \fontsize #-0.8 \italic "cresc." }
  % \set crescendoSpanner = #'text 
}
DECRESC = {
  \set decrescendoText = \markup { \fontsize #-0.8 \italic "decresc." }
...
%0-5
  mib4-2( |
  lab4-5 _\SEMPRELEGATO ) lab4.-4( sib8) |
lab4 sol4.( sib8-5) |
sib4-4( lab sib) |
do2 mib,4( |
<do mib do'>4) <do mib do'>4.( <reb mib reb'>8) |
%6-10
<do mib do'>4 <sib mib sib'>4.-4( <do mib do'>8) |
<sib mib sib'>4-4( <lab mib' lab>-4 mib''8.[ reb16] | \break
do2-3) mib4-2( |
lab4-5) lab4.-4( sib8) |
lab4 sol4.( sib8-5) |
%11-14
...
sib4 \tuplet 6/4 { lab8 sib16 lab sol lab } do8. [sib16]
lab2
}
...
<reb lab'>2 \tuplet 6/4 { sib'16 lab sol lab8 lab16 }
dob4 ( sib lab)
}
...
%46-50
\TUPNO \oneVoice
\tuplet 9/6 { fa8)[ lab reb]  fa^>[ reb lab]   fa[ lab reb] }
\tuplet 9/6 { lab8[ reb fa]  lab^>[ fa reb]   lab[ reb fa] }
\tuplet 9/6 { re8 [ fa lab]    mib[ solb lab] mib[ solb la] }
\tuplet 9/6 { do,8[ solb' sib] do,[ fa lab!]   do,[ mib solb] }
%51-55
\tuplet 9/6 {  fa8[ lab reb]  fa^>[ reb lab]   fa[ lab reb] }
\tuplet 9/6 { lab8[ reb fa]  lab^>[ fa reb]   lab[ reb fa] }
\tuplet 9/6 { re8 [ fa lab]    mib[ solb lab] mib[ solb la] }
\tuplet 9/6 { do,8[ solb' sib] do,[ fa lab!]  do,[ mib solb] }
\tuplet 9/6 { do,8[ mib fa]   sib,[ reb fa]  lab,[ do fa] }
%56-58
\tuplet 9/6 { lab,8[ sib fa'] solb,[ sib mib]   fa,[ sib reb] }
\tuplet 9/6 { mib,8[ lab do]    fa,[ lab reb] solb,[ lab mib'] }
\tuplet 9/6 { fa,8 [ lab reb] lab[ fa reb] fa[ reb lab] }
\bar ":..:"  % ENTRE 2 RÉPÉTITIONS
}
...
%59-60
\oneVoice
\tuplet 9/6 { fab8[ lab reb] fab^>[ reb lab] fab[ lab reb] }
\tuplet 9/6 { lab8[ reb fab] lab^>[ fab reb] lab[ reb fab] }
%61-65
\tuplet 9/6 { re8 [ fa! lab]   mib[ solb lab]   re,[ fa lab] }
\tuplet 9/6 { mib8[ solb sibb] do,[ fab lab]   do,[ mib solb] }
\tuplet 9/6 { fab8[ lab reb] fab->[ reb lab]   fab[ lab reb] }
\tuplet 9/6 { lab8[ reb fab] lab->[ fab reb]   lab[ reb fab] }
\tuplet 9/6 { mib8[ solb lab]  mib[ solb sib] mib,[ solb do] }
%66-70
\tuplet 9/6 {  reb,8[ fab reb'] \OCTAVEBEG    mib,[ solb mib']  fab,![ lab fab'] } \bar "||" \key do \major
\tuplet 9/6 {  fad,8[ la! fad'] sold,[ si sold'] la,[ dod la'] }
\tuplet 9/6 { sold,8[ mi' sold]   la,[ fad' la] si,[ sold' si] }
\tuplet 9/6 {  dod,8[ mi la]      dod[ la mi]    la[ mi dod] }
\tuplet 9/6 {    la8[ dod mi]      la[ mi dod]   mi[ dod la] } \OCTAVEEND
%71-75
\tuplet 9/6 { dod,8[ mi la]  dod[ la mi]  la[ mi dod] }
\tuplet 9/6 {  la8[ dod mi]  la[ mi dod] mi[ dod la] }
\tuplet 9/6 { mi'8[ dod la] dod[ la mi] la[ mi dod] }
\tuplet 9/6 { la'8[ mi dod]  mi[ dod la] \STAFFDO dod[ la mi] }
\tuplet 9/6 { dod8[ mi la]  dod[ la mi]  dod[ mi la] }
%76-80
\tuplet 9/6 { dod,8[ fad la]   dod[ la fad]  dod[ fad la] } \bar "||" \key reb \major
\tuplet 9/6 { reb,!8 [ fa! lab] reb[ lab fa]   reb[ fa lab] }
\tuplet 9/6 { mib8[ solb lab]   do[ lab solb] mib[ solb lab] }
\tuplet 9/6 { fa8[ lab reb] fa->[ reb lab]  fa[ lab reb] } \STAFFUP \oneVoice
\tuplet 9/6 { lab8[ reb fa] lab^>[ fa reb]  lab[ reb fa] }
%81-85
\tuplet 9/6 { re8 [ fa lab]    mib[ solb lab] mib[ solb la] }
\tuplet 9/6 { do,8[ solb' sib] do,[ fa lab!]  do,[ mib solb] }
...
\STAFFDO
\tuplet 9/6 { fa8[ lab reb] fa[ reb lab]  fa[ lab reb] }
\tuplet 9/6 { fa,8[ lab reb] fa[ reb lab]  fa[ lab reb] }
\tuplet 9/6 { fab,8[ lab reb] fab[ reb lab]  fab[ lab reb] }
\tuplet 9/6 { fab,8[ sib reb] fab[ reb sib]  fab[ sib reb] }
\tuplet 9/6 { mib,8[ sib' reb] mib[ reb sib]  mib,[ sib' reb] }
%96-100
\tuplet 9/6 { mib,8[ sib' reb] mib[ reb sib]  mib,[ sib' reb] } \STAFFUP
mib4-.( mib-. mib-.
mib4-. mib-.) \bar "||" \key lab \major mib ^\SEMPRELEGATO
lab4 lab4.( sib8)
lab4 sol4.( sib8)
%101-105
sib4( lab sib)
...
mib4 -1 \sustainOff\sustainOn mib2 -1 \sustainOff\sustainOn |
mib4 -1 \sustainOff\sustainOn mib -1 \sustainOff\sustainOn mib -1  \sustainOff\sustainOn |
...
la2.
fad16[ sol fad sol] fad [ sol fad sol] \tuplet 3/2 { fad8 mid fad }
}
...
s2.*2
%49-50
s2 \tuplet 3/2 { s4 \cr s8 \! }
\tuplet 3/2 { s4 \decr s8 \! } s2
%51-52
s2.*2
%53-58
s4 \tuplet 6/4 { s4. \cr s4 s8 \! }
\tuplet 6/4 { s4. \decr s8 s8 \! s8 } s4
s4 \DECRESC s2 \decr
s2. \!
s4 s2 \pp
s2.
...
s2.
%61-64
\tuplet 9/6 { s4. s4. \cr s4 s8 \! }
\tuplet 9/6 { s4 \decr s8 \! s4. s4. }
s2.*2
%65-70
s2 \CRESC s4 \cr
s2.*3
...
%81-86
\tuplet 9/6 { s4. s4. \cr s4 s8 \! }
\tuplet 9/6 { s4. \decr s8 s8 \! s8 s4. }
s2.*2
\tuplet 9/6 { s4. s8 s4 \cr s4 s8 \! }
\tuplet 9/6 { s4. \decr s8 s8 \! s8 s4. }
%87-90
\tuplet 9/6 { s4. s4 \DECRESC s8 \decr s4. }
s2.
\DYNEXO #'(1 . 0) s2. \! \pp
s2.
}
...
dynPart = { \override DynamicTextSpanner.style = #'none
...
s2 s4 \cr
s2.*3
\tuplet 9/6 { s4. \! \ff s8 \fff s4 \ff s4. }
\tuplet 9/6 { s4. s8 \fff s4 \ff s4. }
%71-75
\tuplet 9/6 { s4. s8 \fff s4 \ff s4. }
\tuplet 9/6 { s4. s8 \fff s4 \ff s4. }
\tuplet 9/6 { s8 \fff s4 \ff s8 \fff s4 \ff s8 \fff s4 \ff }
s2.
s2. \p
%76-80
s2.
...
s2.
%81-86
\tuplet 9/6 { s4. s4. \cr s4. }
\tuplet 9/6 { s4. \! \mp \decr s8 s8 \! \p s8 s4. }
s2.*2
\tuplet 9/6 { s4. s8 s4 \cr s4. }
\tuplet 9/6 { s4. \! \mp \decr s8 s8 \! \p s8 s4. }
%87-90
\tuplet 9/6 { s4. s4 s8 \decr s4. }
s2.
s2. \! \pp
s2.
}
